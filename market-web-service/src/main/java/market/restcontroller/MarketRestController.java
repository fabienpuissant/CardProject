...
public class MarketRestController {
	 ...
	 * @throws IOException 
	 */
	@GetMapping("MarketService/craftCard/{name}")
	public boolean craftCard(@PathVariable String name) throws IOException { 
		//Call to market service to craft a card via HTTP request on the server but using 
		//the card public model to return the json form of the model to the js file.
		return true;
	}
